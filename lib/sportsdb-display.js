import { mapStatus, mapPhase, buildKnockoutPhaseMap, parseEventScores, extractGroupCode } from "./sportsdb-mapping"
...
export function mapEvent(raw, knockoutPhaseMap = null) {
  ...
  const { homeScore, awayScore, homePenScore, awayPenScore } = parseEventScores(raw)
  ...
  return {
    ...
    homePenScore,
    awayPenScore,
    rawStatus: raw.strStatus || raw.strProgress || null,
    status,
