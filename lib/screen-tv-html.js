...
function renderLeaderboardSlide(leaderboard) {
  ...
  return `<div class="tv-slide-inner tv-slide-inner-leaderboard" style="--lb-rows:${Math.min(leaderboard.length, 10)}">
    <h2 class="tv-slide-title">Top 10 Tipprunde</h2>
    ...
    <div class="tv-slide-body tv-slide-body-leaderboard">${rows}</div>
  </div>`
}
