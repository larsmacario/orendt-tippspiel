...
describe("snapshot matchday labels", () => {
  ...
  it("builds rank delta caption and hint", () => {
    expect(formatRankDeltaCaption("2026-06-14")).toBe("+/- Spieltag 14.06.")
    expect(formatRankDeltaHint("2026-06-14")).toContain("Spieltag 14.06.")
    expect(formatRankDeltaHint("2026-06-14")).toContain("vor diesem Spieltag")
  })
})
